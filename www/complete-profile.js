...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (form) {
    form.addEventListener('submit', async (e) => {
      ...
      const userType = document.getElementById('complete-user-type').value;
      const schoolId = document.getElementById('complete-school').value;
      const classVal = document.getElementById('complete-class').value.trim();
      const sectionVal = document.getElementById('complete-section').value.trim();
      const batchVal = document.getElementById('complete-batch').value.trim();
